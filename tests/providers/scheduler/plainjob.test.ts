...
const mockConfig = {
  profile: 'paranoid',
  providers: { memory: 'cortex', scanner: 'patterns', channels: ['cli'], web: 'none', browser: 'none', credentials: 'keychain', skills: 'database', audit: 'database', sandbox: 'subprocess', scheduler: 'plainjob' },
